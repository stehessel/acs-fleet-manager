...
func PresentDinosaurRequestAdminEndpoint(request *dbapi.CentralRequest, _ account.AccountService) (*admin.Dinosaur, *errors.ServiceError) {
	...
	return &admin.Dinosaur{
		...
		ActualDinosaurVersion: request.ActualCentralVersion,
