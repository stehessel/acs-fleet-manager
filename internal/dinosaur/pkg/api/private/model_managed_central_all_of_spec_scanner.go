...
type ManagedCentralAllOfSpecScanner struct {
	Analyzer ManagedCentralAllOfSpecScannerAnalyzer `json:"analyzer,omitempty"`
	Db       ManagedCentralAllOfSpecScannerDb       `json:"db,omitempty"`
}
